...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, HomeComponent, RegisterComponent, HeaderComponent, FooterComponent, SubHeaderComponent, MuseusComponent, PacoDuquesComponent, DDiogoSousaComponent],
